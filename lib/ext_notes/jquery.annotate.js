...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
        ...
        // Add the canvas
        this.canvas = $('<div class="image-annotate-canvas"><div class="image-annotate-view"><div class="image-annotate-edit-area"></div></div></div>');
		...
		this.canvas.offset(this.image.offset());
    ...
    **/
    ...
    $.fn.annotateEdit = function(image, note) {
        ...
        // Set area
        var area = image.canvas.children('.image-annotate-view').children('.image-annotate-edit-area');
        this.area = area;
		...
		var formPosition = function(e, ui)
		{
			...
			form.css('left', (parseInt(offset.left) - form.width() + parseInt(area.width()) - 14) + 'px');
    ...
    $.fn.annotateView.prototype.setPosition = function() {
        ...
        this.area.css('left', (this.note.left) + 'px');
        this.area.css('top', (this.note.top) + 'px');
        this.form.css('left', (this.note.left - 366 + parseInt(this.note.width)) + 'px');
    ...
    $.fn.annotateView.prototype.resetPosition = function(editable, text) {
        ...
        this.form.css('left', (editable.area.position().left - parseInt(this.form.width()) - 14 + parseInt(editable.area.width())) + 'px');
