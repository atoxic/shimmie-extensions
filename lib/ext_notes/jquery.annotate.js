...
(function($) {
    ...
    **/
    ...
    $.fn.annotateView = function(image, note) {
		...
		var canvas = image.canvas || $(".image-annotate-canvas");

        // Add the area
        this.area = $('<div class="image-annotate-area' + (this.editable ? ' image-annotate-area-editable' : '') + '"><div></div></div>');
		canvas.children('.image-annotate-view').prepend(this.area);
        ...
        this.form.hide();
		canvas.children('.image-annotate-view').append(this.form);
