...
function add_note_init(image_id, x, y)
{
	console.log("add note");
	var image = $('#Imagemain');
	var annotations = image.data("annotations");
	var view = new $.fn.annotateView(annotations, {top: y - 25, left: x - 25, width: 50, height: 50, id: image_id, text: "new note", editable: true, new_note: true});
	view.edit();
	/*
...
function add_note_init_center(image_id)
{
	var x = 35;
	var y = 35;
	var img = $("#main_image");
